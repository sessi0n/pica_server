...
class cPacketMng {
    ...
    get_custom_style(data) {
         ...
         */
        let app_id = data.readInt32LE(0);
        let protocol = data.readInt32LE(4);
        let size = data.readInt32LE(8);
        let uuid = data.readInt32LE(12);
        let packet = data.slice(16, 16 + size);
        return {
            app_id: app_id,
            e_index: protocol,
            size: size,
...
exports.cPacketMng = cPacketMng;
//# sourceMappingURL=mng_packet.js.map